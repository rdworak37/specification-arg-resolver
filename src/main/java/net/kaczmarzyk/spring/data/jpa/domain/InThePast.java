...
public class InThePast<T> extends PathSpecification<T> implements ZeroArgSpecification {

	private static final long serialVersionUID = 1L;

	private final Converter converter;

	public InThePast(QueryContext queryContext, String path, String[] args, Converter converter) {
	...
	public Predicate toPredicate(Root<T> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
		...
		return criteriaBuilder.lessThan(rootPath, now);
	}
